...
[![crate](https://img.shields.io/crates/v/num_parser2)](https://crates.io/crates/num_parser2)
[![license](https://img.shields.io/github/license/0xJWLabs/num_parser2)](https://github.com/0xJWLabs/num_parser2/blob/main/LICENSE)
[![docs](https://img.shields.io/docsrs/num_parser2)](https://docs.rs/num_parser2/0.1.0/num_parser2/)

**num_parser2** is a math interpreter and evaluator, it is fork of [num_parser](https://github.com/BearToCode/num_parser). **num_parser2** allows you to easily **parse** strings into math expressions
and **evaluate** them.
...
- [BearToCode](https://github.com/BearToCode)
